...
git clone -j32 https://github.com/Haseo97/Clang-10.0.0.git -b clang-10.0.0 clang
git clone -j32 https://github.com/najahiiii/priv-toolchains.git -b non-elf/gcc-10.0.0/arm gcc32
git clone -j32 https://github.com/najahiiii/priv-toolchains.git -b non-elf/gcc-10.0.0/arm64 gcc
git clone https://github.com/Mmhmdfas/anykernel3.git --depth=1 anykernel3
echo "Done"
